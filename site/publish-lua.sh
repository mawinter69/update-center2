...
#"$( dirname "$0" )/generate-lua.sh" ./www ./www/download

chmod -R a+r www/download
rsync -avzH --size-only --link-dest=/data/update-center/www/download/plugins /data/update-center/www/download/plugins/ /data/update-site/www/download/plugins
